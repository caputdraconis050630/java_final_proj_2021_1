...
<body>
	...
	<div class="container">
		<form name="newMember" class="form-horizontal" id="join_form" method="post" onsubmit="return checkForm()">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="userPass" type="text" class="form-control" placeholder="pw" >
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="userNickName" type="text" class="form-control" placeholder="nickname" >
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">영어 이름</label>
				<div class="col-sm-3">
					<input name="userName" type="text" class="form-control" placeholder="english name" >
				</div>
			</div>
			<div class="form-group  row ">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="userHello" type="text" class="form-control" placeholder="반갑습니다." >
	...
	$(".join_button").click(function(){
		$("#join_form").attr("action", "/member/processAddMember.do");
		$("#join_form").submit();
	});
});
	</script>

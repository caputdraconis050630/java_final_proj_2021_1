	...
	<div class="container">
		<form name="newMember" class="form-horizontal"
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="userId" type="text" class="form-control" placeholder="id" value="<c:out value=''/>" >
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">비밀번호</label>
				<div class="col-sm-3">
					<input name="userPass" type="text" class="form-control" placeholder="pw" value="<c:out value=''/>" >
				</div>
			</div>
			<div class="form-group  row">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="userNickName" type="text" class="form-control" placeholder="nickname" value="<c:out value=''/>" >
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">영어 이름</label>
				<div class="col-sm-3">
					<input name="userName" type="text" class="form-control" placeholder="english name" value="<c:out value=''/>" >
				</div>
			</div>
			<div class="form-group  row ">
				<label class="col-sm-2">이메일</label>
				<div class="col-sm-10">
					<input type="hidden" name="userEmail" id="mail">
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input name="userHello" type="text" class="form-control" placeholder="phone" value="<c:out value=''/>">
				</div>
			</div>
			<div class="form-group  row">
